const specialValueOverrides = {
  ...
  locationHash(prettyValue, rawValue, itemPath, item, definitions) {
    const location =
      rawValue && definitions.DestinyLocationDefinition[rawValue];
    const vendor =
      location &&
      location.vendorHash &&
      definitions.DestinyVendorDefinition[location.vendorHash];
    ...
    const activity =
      locationRelease &&
      definitions.DestinyActivityDefinition[locationRelease.activityHash];
